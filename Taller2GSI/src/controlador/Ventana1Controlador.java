...
public class Ventana1Controlador implements ActionListener {
    ...
    public String sentenceDetect(String paragraph) throws InvalidFormatException, IOException {
        ...
        InputStream is1 = new FileInputStream("D:\\Especializacion en Ingenieria de Software\\Gestion de Software I\\taller 2\\Taller2-GSI\\Taller2GSI\\models-nlp\\en-token.bin");
	TokenizerModel tokenModel = new TokenizerModel(is1);
	Tokenizer tokenizer = new TokenizerME(tokenModel);
	String tokens[] = tokenizer.tokenize(paragraph);
 	// Parts-Of-Speech Tagging
	// reading parts-of-speech model to a stream 
        InputStream posModelIn = new FileInputStream("D:\\Especializacion en Ingenieria de Software\\Gestion de Software I\\taller 2\\Taller2-GSI\\Taller2GSI\\models-nlp\\en-pos-maxent.bin");
